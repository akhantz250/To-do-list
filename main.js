...
const displayController = (function(){
    ...
    function _setUpTaskForm(){
        ...
        addTaskBtn.addEventListener('click',(e) => {
            ...
            const task = _taskController__WEBPACK_IMPORTED_MODULE_0__.taskController.createTask(title, description, dueDate, priority, box);
...
// taskController.createTask('Homework','Math','2021-07-12','0','default');
// taskController.createTask('Tim\'s birthday','Buy him a present','2023-01-13','3','default');
